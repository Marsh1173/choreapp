...
export const tasks: Task[] = [
    ...
    { name: "Cleaning Checks", id: -5, finished: false, time: undefined, group: groups[0], growInAnimation: false, groupAssignmentIndex: 0, repeatIndex: 0 },
    {
    ...
    { name: "October Budget", id: -8, finished: true, time: undefined, group: undefined, growInAnimation: false, groupAssignmentIndex: 0, repeatIndex: 0 },
    {
